	...
	<div class="container h-100">
		<div class="row justify-content-md-center h-100">
			<div class="card-wrapper">
				<h1 class="h1 text-center"><span style="color: #30a5ff;"> </span> </h1>
				<div class="text-center">
				<img src="{{ url('/img/farmacias.svg') }}" class="img-responsive center-block" style="width: 300px; height: auto; margin-bottom: 10px;">
				</div>
				<div class="card fat">
					<div class="card-body">
